	...
	render() {
		return (
			<tr>
				...
				<td>{this.props.offer.salary} <FormattedPlural value={this.props.offer.salary} one={<FormattedMessage id="million"/>} other={<FormattedMessage id="millions"/>}/>
				</td>
				...
				<td>
					<FormattedNumber
					value={this.props.offer.visualizations}/>
				</td>
